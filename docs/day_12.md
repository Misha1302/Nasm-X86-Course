...
`Slides2026-06.pdf`: `CMP`, `TEST`, таблица `Jcc`, знаковая/беззнаковая интерпретация comparisons и GOTO-форма условий.
...
Для равенства знаковая/беззнаковая интерпретация не важно:
...
Напиши схему на ассемблере для:
