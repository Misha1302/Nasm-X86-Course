...
migration = [
    "# Статус структуры глав",
    "",
    "> Страница сгенерирована автоматически. Канонические источники — `day_01.md` … `day_25.md`.",
    "",
    "Все 25 дней обязаны следовать `course_style.md`. Страница показывает регрессию, если обязательный блок исчез или нарушился порядок учебного каркаса.",
    "",
    "| Глава | Статус | Блоки нового шаблона |",
    "|---|---|---:|",
    *rows,
    "",
    "Статусы: `structured` — обязательный каркас присутствует; `transitional` и `legacy` означают структурную регрессию, которую CI должен отклонить.",
]
